      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          ...
          <motion.div
            ...
            className="glass-panel p-8 rounded-2xl flex items-center justify-between group cursor-pointer border border-white/5 hover:border-luxury-gold/30 transition-all shadow-[0_20px_50px_rgba(0,0,0,0.4)]"
          >
            <div className="space-y-1">
              <p className="text-[9px] text-gray-500 font-black tracking-widest uppercase">{stat.label}</p>
              <div className="flex items-baseline gap-3">
                <span className="text-3xl font-mono font-black text-white tracking-tighter">{stat.value}</span>
                <span className="text-[11px] font-black text-luxury-gold">{stat.sub}</span>
              </div>
            </div>
            <div className="w-14 h-14 rounded-2xl bg-white/5 flex items-center justify-center text-luxury-gold group-hover:scale-110 transition-transform">
              <stat.icon size={28} className="opacity-40 group-hover:opacity-100 transition-opacity" />
            </div>
          </motion.div>
        ))}
      </div>
