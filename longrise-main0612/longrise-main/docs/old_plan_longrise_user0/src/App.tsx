...
interface UserData {
  ...
  hasSetTradingPassword: boolean; // Tracking if the user has set it yet
...
const INITIAL_USER: UserData = {
  ...
  tradingPassword: '', // Start empty
  hasSetTradingPassword: false, // User must set it
