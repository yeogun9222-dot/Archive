...
export default function App() {
  ...
  const [user, setUser] = useState<UserData>(SHARED_MOCK_USERS[1]); // Red Dragon (Investor_99)
    ...
    <div className="min-h-screen relative">
      ...
      <main className="pb-24 lg:pb-0">
        <AnimatePresence mode="wait">
          ...
          {currentView === 'cnyt-market' && <CNYTMarketPage userRank={user.rank} />}
          {currentView === 'usdt-onboarding' && <USDTOnboardingPage onSetView={setCurrentView} />}
          {currentView === 'usdt-fraud-report' && <USDTFraudReportPage onSetView={setCurrentView} />}
